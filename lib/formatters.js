...
class Formatter {
   ...
   * @return {String}
   */
  static format(log, formatter, color) {
...
Formatter.MEDIUM = new Formatter(
  formatter.template('[{time}] - {severity} - {message} {data}', {
    props: {
      time: {
        transformers: ['date']
      },
...
Formatter.LONG = new Formatter(
  formatter.template('[{time} {user}] - {severity} - {message} {data}', {
    props: {
      time: {
        transformers: ['date']
      },
...
Formatter.DETAILED = new Formatter(
  formatter.template('{time} {user} {channel} - {severity} - {message} {data}', {
    props: {
      time: {
