...
class ConsoleLogger extends Logger {
  constructor(options) {
    super(options, new Notifiers.Console(options));
  }
}
...
class FileLogger extends Logger {
  constructor(options) {
    ...
    super(options, new Notifiers.File(options));
  }
...
class RemoteLogger extends Logger {
  constructor(options = {}) {
    super(options, new Notifiers.Remote(options));
  }
}
...
class MemoryLogger extends Logger {
  constructor(options = {}) {
    super(options, new Notifiers.Memory(options));
...
class LoggerPack extends Logger {
  constructor(options, loggers) {
    super(options, new Notifiers.ConsoleNotifier(options));
