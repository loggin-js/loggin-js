...
class Logger {
  ...
  static get(opts = 'default', args = {}) {
    if (
      ...
      let notifier = new Notifier.Console(args);
      switch (opts) {
        case 'file':
          notifier = new Notifier.File(args);
          break;
        case 'remote':
          notifier = new Notifier.Remote(args);
          break;
        case 'memory':
          notifier = new Notifier.Memory(args);
          break;
        default:
          notifier = new Notifier.Console(args);
          break;
      }
