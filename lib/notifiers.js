...
const { Formatter, colorLog } = require('./formatters');
...
class Notifier {
  ...
  setFormatter(formatter) {
    switch (formatter) {
      case 'short':
        this.options.formatter = Formatter.SHORT;
        break;
      case 'medium':
        this.options.formatter = Formatter.MEDIUM;
        break;
      case 'long':
        this.options.formatter = Formatter.LONG;
        break;
      case 'detailed':
        this.options.formatter = Formatter.DETAILED;
        break;
      case 'minimal':
        this.options.formatter = Formatter.MINIMAL;
        break;
      default:
        this.options.formatter = Formatter.MEDIUM;
    }
