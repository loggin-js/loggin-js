import { LogginJS } from './../lib/index';

export default function plugin({ Formatter, formatterRegistry }: LogginJS) {
  ...
  formatterRegistry
    ...
    .register('SHORT', '[{time}] - {level} - {message}', {
      props: {
        time: {
          transformers: ['toLocaleDate'],
        },
        level: {
          transformers: ['toString', 'levelToColoredName'],
        },
        message: {},
      },
    })
    .register('MEDIUM', '[{time}] - {level} - {message} {data}', {
      props: {
        time: {
          transformers: ['toLocaleDate'],
        },
    ...
    .register('DEFAULT', '[{time}] - {level} - {message} {data}', {
      props: {
        time: {
          transformers: ['toLocaleDate'],
        },
    ...
    .register('LONG', '[{time} {user}] - {level} - {message} {data}', {
      props: {
        time: {
    ...
    .register('DETAILED', '{time} {user} {channel} - {level} - {message} {data}', {
      props: {
        time: {
    ...
    .register('MINIMAL', '{channel} - {message}', {
      props: {
        message: {},
        channel: {},
      },
